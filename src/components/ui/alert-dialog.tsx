...
>(({ className, children, ...props }, ref) => {
  // Check if AlertDialogTitle is present in children (recursively)
  const hasAlertDialogTitle = React.useMemo(() => {
    const checkForTitle = (element: any): boolean => {
      if (!React.isValidElement(element)) return false;

      const elementType = element.type as any;

      // Found AlertDialogTitle
      if (elementType.displayName === AlertDialogTitle.displayName) {
        return true;
      }
